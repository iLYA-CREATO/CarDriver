...
//     version 1.4.4
//     from Assets/Common/Scripts/Input/InputSystem/SceneInputActions.inputactions
//
        ...
        public struct SceneControlsActions
        {
            ...
            public void SetCallbacks(ISceneControlsActions instance)
            {
                if (m_Wrapper.m_SceneControlsActionsCallbackInterface != null)
                {
                    ...
                    @ShowCursor.started -= m_Wrapper.m_SceneControlsActionsCallbackInterface.OnShowCursor;
                    @ShowCursor.performed -= m_Wrapper.m_SceneControlsActionsCallbackInterface.OnShowCursor;
                    @ShowCursor.canceled -= m_Wrapper.m_SceneControlsActionsCallbackInterface.OnShowCursor;
                }
